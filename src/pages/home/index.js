...
<<<<<<< HEAD
      <div className={'d-flex justify-content-around align-items-center'} style={{height : "70vh"}}>
        ...
        <Link to={data.user.roles.indexOf('CLIENT') !== -1 ? '/home/type/client' : '/register/user/client'} state={{type: "client"}} className={'shadow-lg p-5 text-dark'}>
...
>>>>>>> d0add86241e4fb2db39c15b75cf77b77fcddda71
        </Link>
<<<<<<< HEAD
        <Link to={data.user.roles.indexOf('AGENCIES') !== -1 ? '/home/type/agency' : '/register/user/agency'} state={{type: "agency"}} className={'shadow-lg p-5 text-dark'}>
