...
const ServiceForm = ({ serviceData = {}, type, title }) => {
  ...
  const handleSubmit = async e => {
    ...
    if (code === 200) {
      typeof window !== "undefined" && (await navigate("/home/my-profile"))
    } else {
    ...
    <Layout>
      ...
      <form>
        ...
        <div className="form-group">
          ...
          <textarea
            id={"description"}
            value={state.dataToSend.description}
            placeholder={
              "By using our service your sale will improve up to 10% if your total sale is about 1000"
            }
            className={"form-control"}
            onChange={handleChange}
          ></textarea>
        ...
        <div className={"d-flex flex-column"}>
          <div className={"my-3"}>Please input your service price range :</div>
          <div className={"d-flex align-items-center"}>
            <div className={"form-group"}>
              ...
              <input
                ...
                type={"number"}
                placeholder={"1000000"}
                value={state.dataToSend.priceStart}
                onChange={handleChange}
                id={"priceStart"}
              />
            </div>
            ...
            <div className={"form-group"}>
              ...
              <input
                ...
                placeholder={"5000000"}
                id={"priceEnd"}
                value={state.dataToSend.priceEnd}
                onChange={handleChange}
              />
            </div>
          </div>
