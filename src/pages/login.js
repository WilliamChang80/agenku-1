            ...
            <div className={'w-50'}>
              ...
              <form>
                ...
                <div className={'d-flex flex-column'}>
                  ...
                  <div>
                    <input name={'email'} id={'email'} type={'email'} value={state.email} className={'w-100'} style={{padding : '.5rem', border : 'none'}} onChange={handleChange}/>
                  </div>
                </div>
                ...
                <div className={'d-flex flex-column mt-3'}>
                  ...
                  <div>
                    <input name={'password'} id={'password'}  type={'password'} value={state.password} className={'w-100'} style={{padding : '.5rem', border : 'none'}} onChange={handleChange}/>
                  </div>
                </div>
                <div className={'text-right font-weight-light'} style={{letterSpacing : '1px'}}>
                  ...
                  <div type={"submit"} id={'submit'} onClick={handleSubmit} className={' my-3 d-flex align-items-center justify-content-center'} style={{backgroundColor: '#daa520', height: '50px'}}>
              ...
              <div className={'d-flex align-items-center'}>
                <hr width={'45%'} style={{height: '2px', backgroundColor: '#d4d4d4'}}/>
