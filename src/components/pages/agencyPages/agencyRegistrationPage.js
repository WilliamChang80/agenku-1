  ...
  return (
    <Layout>
      ...
      <form>
        ...
        <div className="form-group">
          <label htmlFor="types" className={"form-input-check"}>
            What are your Services types?
          </label>
          <div>
            {state.allTypes.map((type, index) => {
              return (
                <div key={type.id} className={"custom-control custom-checkbox"}>
                  <input
                    type={"checkbox"}
                    name={"type"}
                    onChange={handleChangeClientTypes}
